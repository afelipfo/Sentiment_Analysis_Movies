...
def remove_html_tags(text: str) -> str:
    ...
    """
    # TODO
    cleaned_text = BeautifulSoup(text, "html.parser")
...
def remove_accented_chars(text: str) -> str:
    ...
    cleaned_text = ''.join(char for char in normalized_text if unicodedata.category(char) != 'Mn')
...
def remove_special_chars(text: str, remove_digits: Optional[bool] = False) -> str:
    ...
    if remove_digits: 
        ...
        cleaned_text = re.sub(r'[^a-zA-Z\s0-9]', '', text)
